    ...
    <div class="cale-all">
     <div @click.stop=""  @touchstart.stop="" class="calendar" v-show="show" :style="{'left':x+'px','top':y+'px'}" transition="calendar" transition-mode="out-in">
        <div class="calendar-tools">
            <i class="glyphicon glyphicon-menu-left float left" @click="prev"  @touchstart="prev"></i>
            <i class="glyphicon glyphicon-menu-right fa-angle-right float right" @click="next"  @touchstart="next"></i>
            <div class="text center">
                <input type="number" v-model="year"  @change="render(year,month)" min="1970" max="2100" maxlength="4" number>
                 / 
                {{month+1}}
            </div>
        </div>
        ...
        <div class="calendar-time" v-show="type=='datetime'||type=='time'">
            ...
            <div class="timer">
                ...
                时
                <input type="number" v-model="minute"  min="0" max="59" maxlength="2" number>
                分
                <input type="number" v-model="second"  min="0" max="59" maxlength="2" number>
                秒
            </div>
        </div>
