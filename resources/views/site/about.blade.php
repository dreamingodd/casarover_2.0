...
@section('body')
    ...
    <div class="case" id="brand-culture">
        <h2>品牌文化</h2>
        <dl>
            <dt>自然</dt>
    ...
    <div class="case" id="charge-standard">
        <h2>合作推广收费标准</h2>
        <p>头条：8000元，阅读量：2万+</p>
    ...
    <div class="case" id="free-promotion">
        <h2>免费推广</h2>
        <h3>一、花千谷</h3>
    ...
    <div class="case" id="personal-customized">
        <h2>私人定制</h2>
        <h3>1、针对顾客</h3>
